...
public class Content extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //inisial tombol
        mBtn_Back = (Button)findViewById(R.id.btn_backCon);
        ...
        mbtn_Contoh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBtn_contoh = new Intent(getApplicationContext(),contoh_content.class);
        ...
        mBtn_Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iBtn_Back = new Intent(Content.this,MainActivity.class);
